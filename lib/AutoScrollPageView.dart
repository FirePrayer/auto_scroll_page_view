...
class _AutoScrollPageViewState extends State<AutoScrollPageView>
{
    ...
    void initState()
    {
        ...
        for (int i = 0; i < _bufferPageLen; i++)
        {
            ...
            _autoScrollWidgetList.add(widget.widgetList[i % widget.widgetList.length]);
        }
        ...
        Function timerCallback = (Timer timer)
        {
            ...
            _currentIndex++;
            _pageController.animateToPage(_currentIndex, duration: widget.animationDuration, curve: widget.curve,);
//                    .whenComplete(()
//            {
...
//            });
    ...
    void _correctionCurrentIndex()
    {
        ...
        {
            _currentIndex = _currentIndex % widget.widgetList.length + widget.widgetList.length;
            _pageController.jumpToPage(_currentIndex);
        }
        else if (_currentIndex > _autoScrollWidgetList.length - 1 - _bufferPageLen)
        {
